// Shared 1.5px-stroke line icons for the chat UI. One size (16), inherit color.
const base = {
  width: 16,
  height: 16,
  viewBox: "0 0 24 24",
...
// eye with a slash: "temporary, not recorded"
...
export const EyeOffIcon = () => (
  <svg {...base}>
    ...
    <path d="M6.6 6.6A13.3 13.3 0 0 0 2 12s3.5 7 10 7a9.1 9.1 0 0 0 4.5-1.16" />
